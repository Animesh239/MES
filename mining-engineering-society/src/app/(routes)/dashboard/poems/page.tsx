...
import {
  ...
  updatePoem,
  deletePoem,
} from "@/actions/mes/minerva/poems/action";
...
export default function PoemsManagement() {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400 mt-2">
            Manage poems for the Minerva publication
          </p>
        </div>
        {!showAddForm && (
          <Button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Textarea
                ...
                className="mt-2 bg-black/30 border-gray-700 text-white placeholder-gray-500 focus:border-orange-500 focus:ring-orange-500 min-h-[200px]"
                placeholder="Enter poem content in MDX format..."
                required
              />
      ...
      <div className="bg-black/40 backdrop-blur-xl rounded-2xl border border-gray-700/50 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-700/50">
          <h2 className="text-xl font-semibold text-white">All Poems</h2>
          <p className="text-gray-400 text-sm mt-1">
            {poems.length} poem{poems.length !== 1 ? "s" : ""} total
          </p>
        </div>
          ...
          {poems.length === 0 ? (
            <div className="px-6 py-12 text-center">
              ...
              <p className="text-gray-400 mb-4">
                Get started by adding your first poem!
              </p>
              <Button
                onClick={() => setShowAddForm(true)}
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center text-gray-400">
                        ...
                        Published:{" "}
                        {new Date(poem.publishDate).toLocaleDateString()}
                      </div>
          ...
          <div className="bg-black/60 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6 max-w-4xl max-h-[80vh] overflow-y-auto">
            <div className="mb-6">
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-400 mb-4">
                ...
                <div className="flex items-center">
                  ...
                  {new Date(viewingPoem.publishDate).toLocaleDateString()}
                </div>
              </div>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: renderMDXContent(viewingPoem.content),
              }}
            />
          </div>
        )}
